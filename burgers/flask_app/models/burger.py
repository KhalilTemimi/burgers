...
class Burger:
    ...
    def save(cls,data):
        ...
        return connectToMySQL('burgers_erd').query_db(query,data)
    
    @classmethod
    def get_all(cls):
        query = "SELECT * FROM burgers;"
        burgers_from_db =  connectToMySQL('burgers_erd').query_db(query)
        burgers =[]
    ...
    def get_one(cls,data):
        ...
        burger_from_db = connectToMySQL('burgers_erd').query_db(query,data)
    ...
    def get_burger_with_toppings( cls , data ):
        ...
        results = connectToMySQL('burgers_erd').query_db( query , data )
